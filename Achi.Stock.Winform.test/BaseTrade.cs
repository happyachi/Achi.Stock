...
{
	public partial class BaseTrade : Form
	{
		private MemberDto _member;
		public BaseTrade(MemberDto member)
		{
			InitializeComponent();
			_member = member;

			this.Load += BaseTrade_Load;
		}

		private void BaseTrade_Load(object sender, EventArgs e)
		{
			OpenChildForm(new FormStockSearch(_member, "Trade"));
		}
		...
		private void buttonTradeData_Click(object sender, EventArgs e)
		{
			OpenChildForm(new FormTradeDataSearch(_member));
		}
