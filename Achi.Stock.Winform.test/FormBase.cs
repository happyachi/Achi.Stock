...
namespace Achi.Stock.Winform.test
{
	public partial class FormBase : Form
	{
		...
		public FormBase(MemberDto member)
		{
			InitializeComponent();
			_member = member;
		...
		{
			OpenChildForm(new FormBaseAccount(_member));
		}

		private void _formBaseMember_FormClosing(object sender, FormClosingEventArgs e)
		{
		...
		{
			OpenChildForm(new FormRanking(_member));
		}
	}
}
